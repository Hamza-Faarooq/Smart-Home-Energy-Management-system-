...
def receive_energy_usage():
    try:
        ...
        return jsonify({'message': 'energy usage data received successfully'}), 200
...
def generate_energy_insights():
    try:
        ...
        return jsonify({'insights': insights, 'future_energy_demand': future_energy_demand}), 200
    except exception as e:
        return jsonify({'error': 'failed to generate energy insights', 'details': str(e)}), 500
